...
Vue.component('dashboard-component',{
    ...
    methods: {
        getter() {
            ...
            axios.post('console/dashbord', formData, config, {}).then((response) => {
                // $(".card-bg").addClass('bg-green');

                console.log(response.data);
                this.mairie = response.data.mairie;
...
function pie_administred(data) {
    ...
    for (var i = 0;i<data.length; i++){
        objetPie[jj] = JSON.parse('{"value":' + data[i].total + ',"name":"' + data[i].nom + '"}');
        legend[jj] = data[i].nom;
        jj++;
    }
    require(
        [
        ...
        function (ec) {
            var opt ={
                title : {
                    subtext: 'Nombre d\'administrés par mairie',
                    x:'center'
                },
                // color: ['#50A5D8', '#DE725C'],
                tooltip : {
...
function pie_commerce(data) {
    ...
    require(
        ...
        function (ec) {
            var opt ={
                title : {
                    subtext: 'Nombre de commerces par mairie',
                    x:'center'
                },
                // color: ['#50A5D8', '#DE725C'],
                tooltip : {
