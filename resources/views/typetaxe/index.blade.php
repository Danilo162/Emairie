...
@section('content')
    ...
    <div class="container-fluid">
        <div class="block-header">
            <h2>LISTE DES TYPE DE TAXE<span class="orange-text total-text total_count"></span></h2>
        </div>
        <!-- Color Pickers -->
                                ...
                                <div class="body">
                                    <div class="col-lg-12 table_custom">
                                        ...
                                        <table id="table"
                                               ...
                                               data-url="{{ route('console.typetaxe.index') }}"
                                    ...
                                    <div class="input-group">
                                        <div class="form-line" :class="{'focused error':e_name !=='' }">
                                            <input type="text" id="name" name="name"
                                                   class="form-control"
                                                   placeholder="Nom du type de taxe">
    ...
    <input type="hidden" id="store" value="{{route('console.typetaxe.store')}}">
    <input type="hidden" id="destroy" value="{{route('console.typetaxe.destroy')}}">
    @stack('scripts')
    ...
    <script src="{{ asset('js/console/typetaxe.js') }}"></script>
