...
<head>
    ...
    <title>E-mairie | ADVANTECH </title>
    <!-- Favicon-->
    ...
    <link href="{{asset('boostrap-table/bootstrap-table.css')}}" rel="stylesheet">
    <!-- Waves Effect Css -->
...
<style>
    .sidebar .user-info{
        background: url({{asset('images/barner.jpg')}}) no-repeat no-repeat;
...
@else
    <style>
        .sidebar .user-info{
            background: url({{asset('storage/'.mairies()->picture)}}) no-repeat no-repeat;
            background-size: cover;
        }
        .card{
...
@endif
<body class="theme-{{theme()}}" id="app" home-url="{{url('/')}}">
<script>
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('console.home')}}">MyEMairie</a>
        </div>
...
{{--                <!-- Notifications -->--}}
                @if(count(getAllService("","TRAITEE"))>0)
                <li class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button">
                        <i class="material-icons">notifications</i>
                        <span class="label-count" style="background-color:red ">{{count(getAllService("","TRAITEE"))}} </span>
                    </a>
                            ...
                            <ul class="menu">
                                <li>
                                    <a href="">
                                        ...
                                        <div class="menu-info">
                                            <h4>{{count(getAllService("ATTENTE",""))}} en attente</h4>
                                            <p>
                                ...
                                <li>
                                    <a href="">
                                        ...
                                        <div class="menu-info">
                                            <h4>{{count(getAllService("EN TRAITEMENT",""))}} en traitement</h4>
                                            <p>
                                                <i class="material-icons">access_time</i>
                                            </p>
                                        </div>
               ...
               {{-- <li class="dropdown">
                ...
                <li class="dropdown">
                    <a onclick="event.preventDefault();
                       ...
                       {{ __('Logout') }}
                       href="{{url('logout')}}" class="dropdown-toggle" data-toggle="dropdown"
                       role="button">
                        <i class="fa fa-times"> Déconnexion</i>
{{--                        <span class="label-count">Deconnexion</span>--}}
                    </a>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            ...
            <div class="info-container">
                <div class="name" style="color: blue; font-weight: bold" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{auth()->user()->name}}</div>
                <div style="color: blue; font-weight: bold" class="email">{{auth()->user()->email}}</div>
                <div class="btn-group user-helper-dropdown">
                    <i class="material-icons" data-toggle="dropdown" style="color: blue" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
                    <ul class="dropdown-menu pull-right">
                        <li><a href="{{route('console.agent.profil')}}"><i class="fa fa-user"></i> Profil</a></li>
...
{{--                        <li><a href="javascript:void(0);"><i class="material-icons">favorite</i>Likes</a></li>--}}
                        ...
                        <li><a  onclick="event.preventDefault();
                                ...
                                {{ __('Logout') }}
                                href="{{url('logout')}}">
                                <i class="fa fa-times"></i> Déconnexion</a>
{{--                            <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">--}}
{{--                                @csrf--}}
{{--                            </form>--}}
                        </li>
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li>
                    <a href="{{route('console.actualite')}}">
                        <i class="material-icons">business</i>
                        <span>Actualités</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('console.demande')}}">
                        <i class="material-icons">business</i>
                        <span>Demande</span>
                    </a>
                </li>

                @can("Tableau de bord des taxes")
                <li class="">
                    <a href="{{route('console.taxecommerce')}}">
                        <i class="material-icons">money</i>
                        <span>Taxes/Impots</span>
                    </a>
                </li>
                @endcan
                @can("Listing Taxe  Mois")
                <li class="">
                    <a href="{{route('console.month')}}">
                ...
                @can('Listing Commerces')
                <li>
                    <a href="{{route('console.commerce')}}">
                        <i class="material-icons">business</i>
                        <span>Commerces</span>
                    </a>
                </li>
                @endcan
                @can('Listing Administrés')
                <li>
                    <a href="{{route('console.administred')}}">
                ...
                @can('Listing Mairies')
                <li>
                    <a href="{{route('console.mairie')}}">
                        <i class="material-icons">business_center</i>
                        <span>Mairies</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('console.mairie',["type"=>"ministere"])}}">
                        <i class="material-icons">business_center</i>
                        <span>Ministères</span>
                    </a>
                </li>
                @endcan
                @can('Listing Paramètres')
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="{{route('console.commune')}}">
                                <span>Commune</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('console.typeactualite')}}">
                                <span>Type Actualité</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('console.service')}}">
                                <span>Services</span>
                            </a>
                        </li>
                        ...
                        @can('Listing Zones')
                            <li>
                                <a href="{{route('console.zone')}}">
                                    <span>Zone</span>
                                </a>
                            </li>
                        @endcan
                        @can('Listing Type de taxe')
                            <li>
                                <a href="{{route('console.typetaxe')}}">
                                    <span>Type de taxe</span>
                                </a>
                            </li>
                        @endcan
                        @can('Listing paiements')
                        <li>
                            <a href="javascript:void(0);">
                        ...
                        @can('Listing Roles')
                        <li>
                            <a href="{{route('console.role')}}">
                                <span>Rôle</span>
                            </a>
                        </li>
                        @endcan
                        <li>
                            <a href="{{route('console.permission')}}">
                                <span>Permissions</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('console.theme')}}">
                                <span>Thèmes</span>
                            </a>
                        </li>
                   {{--     <li>
                            <a href="{{route('console.setting')}}">
                                <span>Signature</span>
                            </a>
                        </li>--}}
                    </ul>
        ...
        <div class="legal">
            <div class="copyright">
                Copyright &copy; <script>document.write(new Date().getFullYear());</script> | <a href="https://advantech-sa.com/">Advantech SA - All rights reserved</a>.
            </div>
        </div>
        <!-- #Footer -->
    </aside>
