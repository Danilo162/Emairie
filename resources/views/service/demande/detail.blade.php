    ...
    <div class="container-fluid">
       ...
       <div class="body" style="background: #fefafa14">
              ...
              <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li role="presentation" class="">
                      <a href="#signature" data-toggle="tab" aria-expanded="false">
                          <i class="fa fa-signature"></i> AUTRES
                      </a>
                  </li>
{{--                  <li role="presentation" class="">--}}
...
{{--                                      <i class="fa fa-user-lock  fs-14"></i>--}}
                  ...
                  <div role="tabpanel" class="tab-pane fade" id="signature">
                      ...
                      <br>
                      <form id="frmCreateSetting"  @submit.prevent="storeSetting"  class="form-horizontal"
                          ...
                          <div class="row clearfix">
                              ...
                              <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                  <div class="form-group">
                                      <div class="form-line">
                                          <input name="phone" required type="text" value="{{mairies()->phone}}" class="form-control" >
                                      </div>
                                  </div>
                              </div>
                          </div>
                          <div class="row clearfix">
                              ...
                              <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                  <div class="form-group">
                                      <div class="form-line">
                                          <input name="email" value="{{mairies()->email}}" required type="email"  class="form-control" >
                                      </div>
                                  </div>
                              </div>
                          </div>
                          ...
                          <button type="submit" class="btn btn-primary waves-effect submitbtn pull-right">Enregistrer</button>
                          <br>

                      </form>
                      <br>
                      <div class="block-header head_build bg-effet">
                          <h2> <span class="fa-1x"> Ma signature</span>

                          </h2>
                      </div>
                      <br>
                      <form  id="frmCreateSettingSigntaure"  @submit.prevent="storeSettingSigntaure" class="form-horizontal"
                            method="POST">
                          <div class="row clearfix">
                              <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                  <label for="email_address_2">Signature</label>
                              </div>
                              <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                  <div class="form-group">
                                      <div class="form-line">
                          ...
                          <img src="{{asset('storage/'.$data->signature)}}" style="height: 80px" alt="">
                      </form>
    ...
    <input type="hidden" id="settingStore" value="{{route('console.setting.store')}}">
