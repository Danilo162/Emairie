...
@section('content')
    ...
    <div class="container-fluid">
        <div class="block-header">
            <h2>LISTE DES SERVICES <span class="orange-text total-text total_count"></span></h2>
        </div>
        <!-- Color Pickers -->
                                ...
                                <div class="body">
                                    <div class="col-lg-12 table_custom">
                                        <table id="table"
                                               ...
                                               data-url="{{ route('console.service.index') }}"
    ...
    <input type="hidden" id="store" value="{{route('console.service.store')}}">
    <input type="hidden" id="destroy" value="{{route('console.service.destroy')}}">
    @stack('scripts')
