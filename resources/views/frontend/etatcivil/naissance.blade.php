    ...
    <div class="row profile" style="padding-top: 0px;">
        ...
        <div class="col-md-9">
            ...
            <div class="profile-content">
                ...
                <header class="panel-heading h4" style="border-bottom: 1px solid #eee;margin-bottom: 20px;"> DEMANDE D'ACTE DE NAISSANCE</header> 
		        ...
		        <form method="POST" id="form-demande-naissance" class="signup-form" enctype="multipart/form-data" action="{{route('etatcivil.SaveDemandeActeNaissance')}}">
		        ...
		        <div class="col-md-12" style="padding: 0px;">
	                ...
	                <div class="col-md-6">
						...
						<div class="group card-name">
	                        ...
	                        <select name="mairie_id" class="input" required style="margin-bottom: 10px;">
	                    ...
	                    <div class="group card-name">
	                        ...
	                        <input type="date" class="input" style="padding: 0px 5px;" name="titulaire_date_naissance" required>
	                    </div>
	                ...
	                <div class="col-md-6">
	                    ...
	                    <div class="group card-name">
	                        ...
	                        <input type="text" class="input" name="titulaire_nom_pere" required>
	                    </div>

	                    <div class="group card-name">
	                        <label for="name">Nom et prénoms de la mère</label>
	                        <input type="text" class="input" name="titulaire_nom_mere" required>
	                    </div>
	                    ...
	                    <div class="group card-name">
	                        ...
	                        <select name="qualite_demandeur" class="input" style="margin-bottom: 10px;" required>
	                    ...
	                    <div class="group card-name">
	                        ...
	                        <textarea class="input" name="motif" style="height:98px;" required></textarea>
	                    </div>
