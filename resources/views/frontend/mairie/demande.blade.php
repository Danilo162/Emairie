...
<div id="main" class="clearfix" style="margin-top:6px; border-top-left-radius:10px; border-top-right-radius:10px;">
    <div class="inner-wrap clearfix">
        ...
        <div id="primary" class="">
            ...
            <form class="form-horizontal letter" id="frmCreate"
                ...
                <div class="row bg-color-gris-effet-1 " style="padding: 10px;border-radius: 5px">
                    ...
                    <div style="vertical-align: middle;padding: 25px 0 10px 0" class="col-lg-9">{{$data->nom}}
                    <div style="font-size: 12px;border-left: 1px solid #acacac;padding-left: 5px">
                        <br><br> <b>Objet : </b>
                        {{$service->name}}
                        <br><b>Prix : </b>
                       <span style="color: red"> {{$service->price ." ".montant_simbole()}}</span> / Unité
                    </div>
                    </div>
                </div>
     ...
     {{--           <div class="form-group row" @if($service->type == "MINISTERE") style="display: none" @endif>
                    <label for=""
                ...
                <div class="form-group row " >
                    ...
                    <div class="col-sm-4">
                        <input style="background: white" :class="{'alert alert-danger':e_quantite !=='' }"  required type="text" name="quantite" class="form-control  form-control-sm" id="quantite" >
                ...
                <div class="form-group row " >
                    <label for=""
                           class="col-sm-4 col-form-label col-form-label-sm">Total</label>
                    <div class="col-sm-4">
                        <input style="background: white;color: red" readonly id="total"   required type="text"  class="form-control  form-control-sm" >

                    </div>
                </div>
                <div class="form-group row " >
                    <label for=""
                           class="col-sm-4 col-form-label col-form-label-sm">Mode de paiement </label>
                    <div class="col-sm-7">
                        <select style="width: 100%" required :class="{'alert alert-danger':e_mode_paiement !=='' }"  name="mode_paiement" id="" class="form-control select2">
                            @foreach($modes as $mode)
                                <option value="{{$mode->id}}">{{$mode->name}}</option>
                            @endforeach
                        </select>

                        <span v-if="e_mode_paiement" role="alert">
                                                        <strong style="color: red;font-size: 12px">@{{e_mode_paiement}}</strong>
                                                    </span>
                    </div>
                </div>
                <div class="form-group row">
    ...
    <input type="hidden" value='{{$service->price}}' id="price">
